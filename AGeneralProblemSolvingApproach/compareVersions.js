...
- The rules to compare two version numbers:
  ...
  - if the number part of the first version number is larger, than the first
    version number is larger
  - if the number part of the second version number is larger, than the first
    version number is smaller
  - if the number parts of both version numbers are the same, move to the next
    part of the two version numbers
